...
Atividade 2:
Criar uma lista simplesmente encadeada ordenada. Nessa lista já se insere e remove de forma ordenada.
...
- **Adicionar(int value)** - já adiciona na lista ordenada
- **Remover(int index)** - remove pelo index (retorna 0 se deu certo e 1 se deu errado)
- **remover()** - remove o primeiro (retorna 0 se deu certo ou 1 se deu errado)
- **getNodo(int index)** - pegar o nodo, a partir do index (retorna null se não achar)
